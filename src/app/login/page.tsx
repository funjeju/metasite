  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription className="text-xs">운영자 계정으로만 접근 가능합니다</CardDescription>
      </CardHeader>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="w-full max-w-sm space-y-4">
        <div className="flex flex-col items-center gap-2 mb-6">
          ...
          <h1 className="text-xl font-bold">META-SITE</h1>
          <p className="text-sm text-muted-foreground">AI 자동 발행 제어판</p>
        </div>
